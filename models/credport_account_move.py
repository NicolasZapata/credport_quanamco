...
class AccountMove(models.Model):
    ...
    amount_debits = fields.Monetary("debit total", compute="_amount_debit_credit")
    amount_credits = fields.Monetary("credit total", compute="_amount_debit_credit")
    ...
    def update_invoice_status(self):
        ...
        for document in documents:
            document.with_context(
                automatic=True
            ).l10n_co_edi_check_status_electronic_invoice()
